...
class TwoFAMQTT {
  ...
  static const String broker = '192.168.0.29';
  ...
  Future<void> _sendVerification(String id, bool allow) async {
    ...
    final uri = Uri.parse('http://192.168.0.29:3001/api/2fa/$id/${allow ? 'approve' : 'reject'}'); //10.0.2.2 - GLEDE NA SVOJO NAPRAVO - fizicno napravo DRUGACE localhost oziroma 10.0.2.2
